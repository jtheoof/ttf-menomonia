...
MISCFILES    = LICENSE README.md CHANGELOG.md
SRCDIR       = src
EXPORTDIR    = export
CHECK_PREFIX = check
...
DISTPREFIX     := menomonia-fonts-$(VER)
DISTPREFIX_TTF := menomonia-fonts-ttf-$(VER)
...
ttf-dir:: $(SFDFILES)
	...
	$(PYTHON) $(FONTTOOLSCRIPT) src/Menomonia*.ttf
	mv  src/MenomoniaSans-Regular-fixed.ttf src/MenomoniaSans-Regular.ttf 
	mv  src/MenomoniaSans-Italic-fixed.ttf src/MenomoniaSans-Italic.ttf 
...
dist-ttf: ttf
	$(PYTHON) $(FONTTOOLSCRIPT) export/Menomonia*.ttf
	mv  export/MenomoniaSans-Regular-fixed.ttf export/MenomoniaSans-Regular.ttf 
	mv  export/MenomoniaSans-Italic-fixed.ttf export/MenomoniaSans-Italic.ttf 
	tempdir=$$(mktemp -d) \
